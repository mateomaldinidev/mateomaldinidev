...
<div align="center">
  <img src="https://raw.githubusercontent.com/mateomaldinidev/mateomaldinidev/output/github-contribution-grid-snake-dark.svg" width="100%"/>
</div>
...
Proyectos que estoy armando para el portfolio (algunos todavía en etapa de diseño/planeamiento):

- 🔗 **Link Shortener API-first** — clon de Bitly con API pública documentada como núcleo
- 🍋 **Mangos** — administrador de finanzas personales con bot de Telegram integrado
- 🏷️ **Meta Tags Generator** — clon mejorado de metatags.io, foco en front cuidado
- ⚙️ **CLI `.env.example` generator** — herramienta de línea de comandos para devs
